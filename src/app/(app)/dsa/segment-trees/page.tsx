...
import { buildSteps, querySteps, updateSteps } from "@/lib/algorithms/segmentTree";
import { SEGMENT_TREE_CODE_SAMPLES } from "@/lib/codeSamples/segmentTree";
...
export default function SegmentTreesPage() {
  ...
  const codeSamples = SEGMENT_TREE_CODE_SAMPLES[op];
