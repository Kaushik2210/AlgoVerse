...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    href: "/patterns/bit-manipulation",
    category: "pattern",
    description: "XOR cancellation, popcount, and bitmask tricks for O(1)-space solutions",
  },
  {
    slug: "two-heaps",
    title: "Two Heaps",
    href: "/patterns/two-heaps",
    category: "pattern",
    description: "Max-heap + min-heap balanced around the middle for a running median",
  },
  {
    slug: "cyclic-sort",
    title: "Cyclic Sort",
    href: "/patterns/cyclic-sort",
    category: "pattern",
    description: "Place each value at its own index via swaps — O(n) time, O(1) space",
  },
  {
    slug: "k-way-merge",
    title: "K-way Merge",
    href: "/patterns/k-way-merge",
    category: "pattern",
    description: "Size-k min-heap merges k sorted lists in O(N log k)",
  },
  {
    slug: "leetcode",
    title: "LeetCode",
